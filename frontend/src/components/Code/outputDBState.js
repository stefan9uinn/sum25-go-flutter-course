        ...
        return (
            <div>
                ...
                <div className="code-output">
                    {Object.keys(this.props.response).length === 0 || this.props.response.message === "Please try once again, there is an error in your code" ? <Typography.Text className='code-text'>Current DB state will appear here</Typography.Text> : this.props.response.db_state.map((item, index) => {
                        return (
