                    ...
                    <div className="code-output-item">
                        {this.props.response.result.error === "Document not found" ? <Typography.Text className='code-text' style={{ color: '#B22222' }}>ID is not found</Typography.Text> :
                            <div>
                                ...
                                <Typography.Text className='code-text'>-ID: <Typography.Text className='code-text' style={{ color: '#fff' }}>{this.props.response.result.document.id}</Typography.Text></Typography.Text> <br />
                                <Typography.Text className='code-text'>-Title: <Typography.Text className='code-text' style={{ color: '#fff' }}>{this.props.response.result.document.document}</Typography.Text></Typography.Text> <br />
