            ...
            <div>
                {Object.keys(this.props.response).length === 0 ? <Typography.Text className='code-text'>Request result will appear here</Typography.Text> :
                    <div className="code-output-item">
                        ...
                        <Typography.Text className='code-text'>-ID: <Typography.Text className='code-text' style={{ color: '#fff' }}>{this.props.response.db_state[this.props.response.documents_count - 1].id}</Typography.Text></Typography.Text> <br />
                        <Typography.Text className='code-text'>-Title: <Typography.Text className='code-text' style={{ color: '#fff' }}>{this.props.response.db_state[this.props.response.documents_count - 1].document}</Typography.Text></Typography.Text> <br />
